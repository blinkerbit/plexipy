...
class TestAppConfigParser:
    ...
    def test_os_vars_prefixed(self):
        ...
        config_data = {"name": "testapp", "os_vars": {"API_KEY": "secret123", "DEBUG": "true"}}

        AppConfigParser("testapp", config_data)
    ...
    def test_os_vars_isolated(self):
        ...
        config_data = {"name": "testapp", "os_vars": {"API_KEY": "secret123"}}

        AppConfigParser("testapp", config_data, is_isolated=True)
    ...
    def test_get_os_var(self):
        ...
        config_data = {"os_vars": {"MY_VAR": "my_value"}}
    ...
    def test_get_all_os_vars(self):
        ...
        config_data = {"os_vars": {"VAR1": "value1", "VAR2": "value2"}}
    ...
    def test_env_var_resolution_simple(self):
        ...
        config_data = {"settings": {"my_setting": "${TEST_VALUE}"}}
    ...
    def test_env_var_resolution_with_set_var(self):
        ...
        config_data = {"settings": {"my_setting": "${TEST_OVERRIDE:-default}"}}
    ...
    def test_nested_dict_resolution(self):
        ...
        config_data = {"settings": {"level1": {"level2": {"value": "${TEST_NESTED}"}}}}
    ...
    def test_list_resolution(self):
        ...
        config_data = {"settings": {"my_list": ["static", "${TEST_LIST_VAL}", "another"]}}
    ...
    def test_tm1_instances(self):
        ...
        config_data = {
            "tm1_instances": {
                "prod": {"server": "prod.local", "port": "8010"},
                "dev": {"server": "dev.local", "port": "8011"},
            }
        }
    ...
    def test_get_tm1_instance(self):
        ...
        config_data = {"tm1_instances": {"prod": {"server": "prod.local"}}}
    ...
    def test_get_tm1_instance_names(self):
        ...
        config_data = {"tm1_instances": {"prod": {}, "dev": {}, "test": {}}}
    ...
    def test_tm1_instance_env_vars(self):
        ...
        config_data = {"tm1_instances": {"prod": {"server": "prod.local", "port": "8010"}}}
    ...
    def test_tm1_instance_env_resolution(self):
        ...
        config_data = {"tm1_instances": {"prod": {"server": "${TEST_TM1_SERVER}"}}}
    ...
    def test_get_resolved_config(self):
        ...
        config_data = {
            "name": "testapp",
            "settings": {"value": "${TEST_RESOLVED}"},
            "os_vars": {"IGNORED": "value"},
        }
    ...
    def test_to_env_dict(self):
        ...
        config_data = {"os_vars": {"VAR1": "value1"}, "settings": {"timeout": 30}}
    ...
    def test_from_file(self, temp_dir):
        ...
        config_data = {"name": "myapp", "version": "2.0.0"}
    ...
    def test_boolean_in_tm1_instances(self):
        ...
        config_data = {"tm1_instances": {"prod": {"ssl": True, "integrated_login": False}}}
