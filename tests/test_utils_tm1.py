...
class TestTM1InstanceConfig:
    ...
    def test_get_bool(self):
        ...
        config = {"ssl": "true", "integrated_login": "false", "enabled": True}
    ...
    def test_env_var_resolution(self):
        ...
        config = {"server": "${TEST_SERVER}", "port": "${TEST_PORT:-8010}"}
    ...
    def test_build_onprem_params_integrated(self):
        ...
        config = {"connection_type": "onprem", "server": "localhost", "integrated_login": True}
...
class TestTM1ConnectionManager:
    ...
    def test_initialize(self):
        ...
        app_config = {
            "settings": {"default_instance": "production", "session_context": "TestApp"},
            "tm1_instances": {
                "production": {"connection_type": "onprem", "server": "prod.local"},
                "development": {"connection_type": "onprem", "server": "dev.local"},
            },
        }
    ...
    def test_get_instance_config(self):
        ...
        app_config = {
            "tm1_instances": {"prod": {"server": "prod.local"}, "dev": {"server": "dev.local"}}
        }
    ...
    def test_list_instance_names(self):
        ...
        app_config = {"tm1_instances": {"prod": {}, "dev": {}, "test": {}}}
    ...
    def test_has_instance(self):
        ...
        app_config = {"tm1_instances": {"existing": {}}}
    ...
    def test_reset(self):
        ...
        app_config = {"settings": {"default_instance": "test"}, "tm1_instances": {"test": {}}}
    ...
    def test_get_connection_status(self):
        ...
        app_config = {"tm1_instances": {"prod": {"server": "prod.local", "port": "8010"}}}
