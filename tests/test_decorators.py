...
from pyrest.decorators import (
    ...
    RestHandler, create_handler, crud_handlers
)
...
class TestCrudHandlers:
    ...
    def test_crud_handlers_all(self):
        ...
        async def list_fn(handler): pass
        async def get_fn(handler): pass
        async def create_fn(handler): pass
        async def update_fn(handler): pass
        async def delete_fn(handler): pass
